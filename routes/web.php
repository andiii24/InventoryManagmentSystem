...
Route::group(['middleware' => 'auth'], function() {
 ...
 // Vehicle Brand
 Route::get('Vehicles/brands', 'VehicleBrandController@brand')->name('vehicles.brand');
 Route::post('Vehicles/brand/store', 'VehicleBrandController@store')->name('vehicle.brand.store');
 Route::post('Vehicles/brand/update', 'VehicleBrandController@update')->name('vehicle.brand.update');
 Route::get('vehicle/brand/delete/{id}', 'VehicleBrandController@delete')->name('vehicles.brand.delete');
 Route::post('Vehicles/brand/deleteselected', 'VehicleBrandController@deleteBySelection')->name('vehicles.brand.deleteselected');
 //Bank Controller

 Route::get('banks', 'BankController@brand')->name('bank.index');
 ...
 Route::post('bank/deleteselected', 'BankController@deleteBySelection')->name('bank.deleteselected');   
 // Vehicle Category
 Route::get('Vehicle/categories', 'VehicleBrandController@index')->name('vehicle.categories');
 Route::post('vehicle/category/category-data', 'VehicleBrandController@categoryData')->name('vehicle.categories.data');
 Route::post('Vehicles/category/store', 'VehicleBrandController@create')->name('vehicle.category.store');
 Route::get('vehicle/category/edit/{id}', 'VehicleBrandController@edit')->name('vehicles.category.edit');
 Route::post('vehicle/category/update', 'VehicleBrandController@CatUpdate')->name('vehicle.category.update');
 Route::get('vehicle/category/delete/{id}', 'VehicleBrandController@CatDelete')->name('vehicle.category.delete');
 Route::post('vehicle/category/deleteselected', 'VehicleBrandController@CatDeleteBySelection')->name('vehicles.category.deleteselected');
     // Vehicles 
 Route::get('vehicles/create', 'VehicleController@create')->name('vehicle.create');
 Route::post('vehicles/store', 'VehicleController@store')->name('vehicle.store');
 Route::get('vehicles/gencode', 'VehicleController@generateCode');
 Route::get('vehicle/edit/gencode', 'VehicleController@generateCode');
 Route::get('vehicles', 'VehicleController@index')->name('vehicle.index');
 Route::post('vehicle/vehicle-data', 'VehicleController@vehicleData')->name('vehicles.data');
 Route::get('vehicles/getvehicle/{id}', 'VehicleController@getForManufacture');
 Route::get('vehicles/get/raw-vehicle/{id}', 'VehicleController@getRawVehicle');
 Route::post('vehicle/import', 'VehicleController@importVehicle')->name('vehicles.import');
 ...
 Route::post('vehicle/row/update', 'VehicleController@rawUpdate')->name('vehicle.raw.update');
 Route::get('vehicle/delete/{id}', 'VehicleController@destroy')->name('vehicle.delete');
 Route::get('vehicle/raw/delete/{id}', 'VehicleController@rawDelete')->name('vehicle.raw.delete');
 Route::post('vehicle/deleteselected', 'VehicleController@DeleteBySelection')->name('vehicles.deleteselected');
 //manufactures url 
 Route::post('vehicle/add/manufacture', 'VehicleManufactureController@store')->name('vehicle.manufacture.add');
 Route::get('vehicle/manufacture', 'VehicleManufactureController@index')->name('manufacture.index');
 Route::post('vehicle/manufacture-data', 'VehicleManufactureController@manufactureData')->name('manufacture.data');
 Route::get('vehicle/manufacture/get/{id}', 'VehicleManufactureController@getInProgress');
 Route::post('vehicle/manufacture/complete', 'VehicleManufactureController@addComplete')->name('manufacture.complete.add');
 //Finished url
 Route::get('vehicle/finished-goods', 'VehicleManufactureController@finishedIndex')->name('finished.index');
 Route::post('vehicle/finished-data', 'VehicleManufactureController@finishedData')->name('finished.data');
 Route::get('vehicle/finished/get/{id}', 'VehicleProductController@vehicleGet');
 Route::post('vehicle/finished/update', 'VehicleProductController@update')->name('vehicle.finished.update');
 //Products
 Route::post('vehicle/product/add', 'VehicleProductController@store')->name('vehicle.product.add');
 Route::get('vehicle/products', 'VehicleProductController@index')->name('vehicle.product.index');
 Route::post('vehicle/product-data', 'VehicleProductController@productData')->name('vehicle.product.data');
// Import(Purchases) Bank
Route::get('purchase/banks', 'BankerController@index')->name('purchases.bank');
Route::post('purchase/bank-data', 'BankerController@bankData')->name('purchase.bank.data');
Route::post('purchase/bank/store', 'BankerController@store')->name('purchase.bank.add');
Route::post('purchase/bank/update', 'BankerController@update')->name('purchase.bank.update');
Route::get('purchase/bank/delete/{id}', 'BankerController@delete')->name('purchase.bank.delete');
Route::post('banks/deleteselected', 'BankerController@DeleteBySelection')->name('purchase.bank.deleteselected');
// Import(Purchases) Proforma 
Route::get('purchase/proforma-invoices', 'ProformaController@index')->name('purchases.proforma');
Route::post('purchase/proforma-data', 'ProformaController@proformaData')->name('purchase.proforma.data');
Route::post('purchase/proforma/store', 'ProformaController@store')->name('purchase.proforma.add');
Route::get('purchase/proforma/edit/{id}', 'ProformaController@edit')->name('purchase.proforma.edit');
Route::post('purchase/proforma/update', 'ProformaController@update')->name('purchase.proforma.update');
Route::get('purchase/proforma/delete/{id}', 'ProformaController@delete')->name('purchase.proforma.delete');
Route::post('Proformas/deleteselected', 'ProformaController@DeleteBySelection')->name('purchase.proforma.deleteselected');
Route::post('purchase/proforma/item/add', 'ProformaController@addItem')->name('purchase.proforma.item.add');
Route::post('proforma/item/import', 'ProformaController@import')->name('proforma.item.import');
Route::get('purchases/proforma_item/{id}','ProformaController@ProformaItems');
Route::get('proforma/getItem/{id}','ProformaController@getItem');
Route::post('purchase/proforma/item/update', 'ProformaController@updateItem')->name('purchase.proforma.item.update');
Route::get('purchase/proforma/item/delete/{id}', 'ProformaController@itemDelete')->name('purchase.proforma.item.delete');
Route::post('purchase/proforma/bank/submit', 'ProformaController@submitBank')->name('purchase.proforma.bank.submit');
// Import Bank submit, Booking, Transit, Custom and Final Stage
Route::get('purchase/bank-submits', 'BankSubmitController@index')->name('purchases.bank-submit');
Route::post('purchase/bank-submit-data', 'BankSubmitController@submitData')->name('purchase.bank-stage.data');
Route::get('purchase/bank/edit/{id}', 'BankSubmitController@getSubmit');
Route::post('purchase/proforma/booking/add', 'BankSubmitController@addBooking')->name('purchase.proforma.booking.add');
Route::post('proforma/bank/submit/update', 'BankSubmitController@update')->name('proforma.bank.submit.update');
//Bookings 
Route::get('purchase/proforma/bookings', 'BookingController@index')->name('purchases.booking');
Route::post('purchase/booking-data', 'BookingController@bookingData')->name('purchase.booking-data');
Route::get('purchases/booking_containers/{id}','BookingController@containers');
Route::post('purchase/proforma/transit/add', 'BookingController@addTransit')->name('purchase.proforma.transit.add');
//Transition
Route::get('purchase/proforma/transition', 'BookingController@transitionIndex')->name('purchases.transition');
Route::post('purchase/transition-data', 'BookingController@transitionData')->name('purchase.transition-data');
Route::post('purchase/proforma/custom/add', 'BookingController@addCustom')->name('purchase.proforma.custom.add');
// Custom Stage and Proforma Count Controller
Route::get('purchase/proforma/custom-stage', 'ProformaFinalController@customIndex')->name('purchases.custom-stage');
Route::post('purchase/custom-stage-data', 'ProformaFinalController@customData')->name('purchase.custom-stage-data');
Route::get('purchase/proforma/count', 'ProformaFinalController@index')->name('purchases.proforma-count');
Route::post('purchase/proforma-count-data', 'ProformaFinalController@countData')->name('purchase.proforma-count-data');
Route::get('proforma/stock/detail/{id}', 'ProformaFinalController@stockDetail')->name('proforma.count.detail'); 
Route::get('purchase/count/delete/{id}', 'ProformaFinalController@delete')->name('purchase.count.delete');
// Andu Sale Report url
Route::get('sale/product_sales_report','SalesReport@ProSalesReport')->name('sale.product_sales_report');
Route::post('sale/product_sales_report/sorter','SalesReport@sortedByDateProduct')->name('sale.product_sales_report.sortedByDate');
Route::get('sale/vehicle_sales_report','SalesReport@VehSalesReport')->name('sale.vehicle_sales_report');
Route::post('sale/vehicle_sales_report/sorter','SalesReport@sortedByDateVehicle')->name('sale.vehicle_sales_report.sortedByDate');
...
Route::group(['middleware' => ['auth', 'active']], function() { 
	...
	Route::post('category/deletebyselection', 'CategoryController@deleteBySelection')->name('category.deleteselected');
	Route::post('category/category-data', 'CategoryController@categoryData');
	Route::resource('category', 'CategoryController');
	Route::post('brand/deletebyselection', 'BrandController@deleteBySelection')->name('brand.deleteselected'); 
	...
	Route::get('products/saleunit/{id}', 'ProductController@saleUnit'); // if not used deleted
	Route::get('products/getdata/{id}/{variant_id}', 'ProductController@getData'); // if not used deleted
	Route::get('products/product_warehouse/{id}', 'ProductController@productWarehouseData'); // if not used deleted
	...
	Route::post('products/deletebyselection', 'ProductController@deleteBySelection')->name('product.deleteselected');
	...
	Route::get('sales/lims_product_search1', 'VehicleSalesController@limsProductSearch')->name('vehicle_sale.search');
	...
	Route::get('sales/getvehicle/{id}', 'VehicleSalesController@getProduct')->name('vehicle.sale.getproduct');
	Route::get('sales/getproduct/{category_id}/{brand_id}', 'SaleController@getProductByFilter');
	Route::get('sales/getvehicle/{category_id}/{brand_id}', 'VehicleSalesController@getProductByFilter');
	...
	Route::post('sales/deletebyselection', 'SaleController@deleteBySelection')->name('sales.deleteselected');
