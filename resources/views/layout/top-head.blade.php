...
<html>
  <head>
   ...
   <style>
    ...
    #vehicle-table td:hover p {
    color:#7c5cc4
    }

    #vehicle-table_wrapper.dataTables_wrapper {
    margin-top:0;
    padding:0
    }
    ...
    #vehicle-table_paginate {
    float:right
    }
    #vehicle-table tr:last-child td:hover {
    border-bottom:1px solid #7c5cc4
    }
    #vehicle-table_paginate .page-link {
    line-height:1
    }
    #vehicle-table td {
    border:none;
    ...
    #vehicle-table tr:first-child td {
    ...
    #vehicle-table tr:first-child td:hover {
    border-top:1px solid #7c5cc4
    }
    #vehicle-table tr td:first-child:hover {
